          ...
          <div className="container">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Every line gets a bespoke engine and UI mode tuned for Malaysia-specific commuter pain points.
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: 'MRT Putrajaya Line', color: 'bg-yellow-400', usp: 'Speed & Reliability Predictor', detail: 'Predicts fast-track windows and best transfer combos.' },
                { name: 'LRT Ampang / Sri Petaling', color: 'bg-orange-500', usp: 'Delay Survival Mode', detail: 'Auto-reroutes with bus bridges and split-line alerts.' },
