...
export const zh: Translations = {
  ...
  scanner: {
    title: '扫描与 OCR 中心',
    subtitle: '扫描 QR 车票或读取站牌、时刻表和票价牌 — 然后询问 AI 助手。',
    qrTab: 'QR 车票',
    ocrTab: 'OCR 视觉',
    qrHint: '将相机对准 Beat KL traffic 车票二维码',
    ocrHint: '拍摄站牌、时刻表、票价牌或纸质车票 — AI 自动提取文字。',
    scanCamera: '相机扫描',
    cameraUnsupported: '不支持相机',
    enterCode: '输入代码',
    captureSign: '拍摄站牌',
    uploadImage: '上传图片',
    runOcr: '运行 OCR',
    qrAlign: '将二维码对准框内',
    ocrAlign: '框选站牌或时刻表，然后点击运行 OCR',
    cancel: '取消',
    manualPlaceholder: '例如 RAPIDKL-T-A1B2C3-KJ16-MR6',
    validate: '验证',
    validating: '正在验证车票…',
    ocrProcessing: 'AI 视觉正在读取图片…',
    validTicket: '车票有效',
    ocrComplete: '文字已提取',
    failed: '扫描失败',
    ticketId: '车票 ID',
    ...
    scanAnother: '再次扫描',
    tryAgain: '重试',
    signInHint: '登录以验证您账户下的车票。',
    cameraDenied: '相机权限被拒绝。请使用手动输入或上传图片。',
    ticketNotFound: '未找到此二维码对应的车票。',
    validationFailed: '验证失败，请重试。',
    ocrFailed: 'OCR 失败。请尝试更清晰的照片或更好的光线。',
  },
  agent: {
    title: '通勤 AI 助手',
    subtitle: '巴生谷线路感知问答 — 结合您的扫描结果和实时交通数据。',
    signInPrompt: '登录后与 AI 助手对话，获取个性化避堵路线。',
    scanContext: '已配对扫描',
    clearScans: '清除',
